    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=50, unique=True, validators=[po_app.validators.CustomUsernameValidator()])),
                ('email', models.EmailField(max_length=254, unique=True)),
                ('password', models.CharField(max_length=128, validators=[po_app.validators.CustomPasswordValidator()])),
